...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "terraform-web-private-subnet"
  }
}
...
resource "aws_subnet" "private_b" {
  ...
  tags = {
    Name = "terraform-web-private-subnet-b"
  }
}
...
resource "aws_db_subnet_group" "main" {
  name       = "terraform-web-db-subnet-group"
...
resource "aws_security_group" "db_sg" {
  name        = "terraform-web-db-sg"
  description = "Allow MySQL access only from the web server security group"
  vpc_id      = aws_vpc.main.id
